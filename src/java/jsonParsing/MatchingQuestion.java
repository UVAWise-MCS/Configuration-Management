...
public class MatchingQuestion extends BaseQuestion {
	// Using the Question class an array of questions is added as a private
	// member variable
	...
	public MatchingQuestion(String question, String cat) // Overloaded
															// constructor
	{
	...
	public String toString() {
		...
		for (int i = 0; i < matchingItems.size(); i++) {
			result.append((i + 1) + ") " + matchingItems.get(i) + "\t" + ch
					+ ") " + answers.get(i) + NEW_LINE);
			ch++;
		}
